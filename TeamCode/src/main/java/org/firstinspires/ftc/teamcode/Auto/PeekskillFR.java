...
public class PeekskillFR extends LinearOpMode {
    ...
    public final Pose pickupThree = new Pose(103, 35.5, Math.toRadians(0));
    public final Pose pickupThreeFinish = new Pose(118,35.5, Math.toRadians(0));
